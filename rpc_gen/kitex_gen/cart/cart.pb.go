...
var file_cart_proto_rawDesc = []byte{
	...
	0x79, 0x43, 0x61, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x45, 0x0a, 0x04, 0x43, 0x61, 0x72,
	...
	0x74, 0x79, 0x43, 0x61, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x40, 0x5a, 0x3e,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4d, 0x65, 0x6c, 0x6f, 0x64,
	0x79, 0x44, 0x65, 0x65, 0x70, 0x2f, 0x54, 0x69, 0x6b, 0x54, 0x6f, 0x6b, 0x2d, 0x45, 0x2d, 0x63,
...
var file_cart_proto_depIdxs = []int32{
	...
	3, // 4: cart.CartService.GetCart:input_type -> cart.GetCartReq
	5, // 5: cart.CartService.EmptyCart:input_type -> cart.EmptyCartReq
	2, // 6: cart.CartService.AddItem:output_type -> cart.AddItemResp
	4, // 7: cart.CartService.GetCart:output_type -> cart.GetCartResp
	6, // 8: cart.CartService.EmptyCart:output_type -> cart.EmptyCartResp
